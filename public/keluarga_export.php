...
$headers = [
    ...
    'Pernah Terima Bantuan Pemerintah', 'Jenis Bantuan', 'Bulan/Tahun Terakhir Menerima Bantuan', 'Deskripsi Bantuan (Lainnya)',
    'Ada UMKM', 'Jumlah Anggota UMKM Laki-laki', 'Jumlah Anggota UMKM Perempuan',
...
foreach ($data as $row) {
    ...
    $line = [
        ...
        $row['pernah_bantuan'],
        $row['jenis_bantuan'],
        formatBulanTahun($row['tanggal_terakhir_bantuan']),
        $row['deskripsi_bantuan'],
        $row['ada_umkm'],
        $row['jumlah_anggota_umkm_lk'],
        $row['jumlah_anggota_umkm_pr'],
        $row['ada_disabilitas'],
